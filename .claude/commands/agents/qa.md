...
## Skills
- crm-vitao360: *audit, *validate
- Detector de Mentira: TODOS os 3 níveis (Existência, Substância, Conexão)
- Verificação pós-build: 0 #REF!, Two-Base, CNPJ, faturamento R$2.091.000
- Classificação 3-tier: REAL / SINTÉTICO / ALUCINAÇÃO
- 558 registros ALUCINAÇÃO catalogados — guardar lista
- Thresholds: faturamento ±0.5%, coverage >90%, motor 92/92
