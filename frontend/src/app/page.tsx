          ...
          <div className="px-5 py-4 flex flex-col sm:flex-row sm:items-center gap-3">
            ...
            <div className="flex items-start gap-3 flex-1 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold text-white/90 uppercase tracking-wider mb-0.5">
                  Insight do Dia
                </p>
            ...
            <div className="flex flex-wrap gap-2 flex-shrink-0">
              <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-white/25 text-xs font-semibold text-white">
