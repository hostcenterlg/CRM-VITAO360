...
export default function CarteiraError({ error, reset }: { error: Error; reset: () => void }) {
    ...
    <div className="min-h-[400px] flex items-center justify-center px-4">
      <div className="text-center space-y-4 max-w-md">
        ...
        <p className="text-sm font-medium text-gray-800">
          {isChunkError ? 'Nova versao disponivel' : 'Erro ao carregar Carteira'}
        </p>
        <p className="text-xs text-gray-500">
          {isChunkError
            ? 'O CRM foi atualizado. Recarregue a pagina para usar a versao mais recente.'
            : error.message}
        </p>
